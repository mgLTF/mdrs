function [PLdata , APDdata , MPDdata , TTdata, PLVoIP, APDVoIP, MPDVoIP] = Sim4A(lambda,C,f,P,n,p)
% INPUT PARAMETERS:
...
%  p      - % queue size acceptance limit for data packets, between [0,1]
% OUTPUT PARAMETERS:
%  PL   - packet loss (%)
    ...
    switch Event
        ...
        case DEPARTURE          % If first event is a DEPARTURE of data packet
            ...
            if QUEUEOCCUPATION > 0
                QUEUE= sortrows(QUEUE,3,"descend");  % Order QUEUE by packet type (VoIP has priority)
